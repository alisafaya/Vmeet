namespace Vmeet.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Yonetici_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AspNetUsers", t => t.Yonetici_Id)
                .Index(t => t.Yonetici_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Toplantis", "Yonetici_Id", "dbo.AspNetUsers");
            ...
            DropForeignKey("dbo.Mesajs", "ApplicationUser_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Katilimcis", "ApplicationUser_Id", "dbo.AspNetUsers");
